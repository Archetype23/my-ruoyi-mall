...
public interface TradeOrderConvert {
    ...
    @Mappings({
            ...
            @Mapping(source = "createReqVO.groupBuyActivityId", target = "groupBuyActivityId"),
            @Mapping(source = "createReqVO.groupBuyHeadId", target = "groupBuyHeadId")
    })
    ...
    default TradePriceCalculateReqBO convert(Long userId, AppTradeOrderSettlementReqVO settlementReqVO,
        ...
        TradePriceCalculateReqBO reqBO = new TradePriceCalculateReqBO().setUserId(userId)
                ...
                .setGroupBuyActivityId(settlementReqVO.getGroupBuyActivityId())
                .setGroupBuyHeadId(settlementReqVO.getGroupBuyHeadId())
