<template>
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item>
        ...
        <el-button plain type="success" @click="handleGroupBuyQuery">社区拼团订单</el-button>
      </el-form-item>
    </el-form>
  </ContentWrap>
  ...
  <OrderPickUpForm ref="pickUpFormRef" @success="getList" />
...
const queryParams = ref({
  ...
  type: undefined as undefined | number, // 订单类型
...
const handleGroupBuyQuery = async () => {
  queryParams.value.pageNo = 1
...
const handleCommand = (command: string, row: TradeOrderApi.OrderVO) => {
  switch (command) {
    ...
    case 'delivery':
      ...
      break
    case 'pickUp':
      pickUpFormRef.value?.open(row.pickUpVerifyCode)
      break
  }
}
